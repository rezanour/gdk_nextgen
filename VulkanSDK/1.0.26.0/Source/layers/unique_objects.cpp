...
// CODEGEN : file C:/releasebuild/LoaderAndValidationLayers/vk-layer-generate.py line #749
...
{
// CODEGEN : file C:/releasebuild/LoaderAndValidationLayers/vk-layer-generate.py line #883
...
// CODEGEN : file C:/releasebuild/LoaderAndValidationLayers/vk-layer-generate.py line #842
...
// CODEGEN : file C:/releasebuild/LoaderAndValidationLayers/vk-layer-generate.py line #980
...
{
    return explicit_GetPhysicalDeviceDisplayPropertiesKHR(physicalDevice, pPropertyCount, pProperties);
}
...
// CODEGEN : file C:/releasebuild/LoaderAndValidationLayers/vk-layer-generate.py line #980
    VkResult result = get_dispatch_table(unique_objects_instance_table_map, physicalDevice)->GetPhysicalDeviceDisplayPlanePropertiesKHR(physicalDevice, pPropertyCount, ( VkDisplayPlanePropertiesKHR*)local_pProperties);
...
{
    return explicit_GetDisplayPlaneSupportedDisplaysKHR(physicalDevice, planeIndex, pDisplayCount, pDisplays);
}
...
{
    return explicit_GetDisplayModePropertiesKHR(physicalDevice, display, pPropertyCount, pProperties);
}
...
// CODEGEN : file C:/releasebuild/LoaderAndValidationLayers/vk-layer-generate.py line #980
    VkResult result = get_dispatch_table(unique_objects_instance_table_map, physicalDevice)->CreateDisplayModeKHR(physicalDevice, display, pCreateInfo, pAllocator, pMode);
    if (VK_SUCCESS == result) {
        std::lock_guard<std::mutex> lock(global_lock);
// CODEGEN : file C:/releasebuild/LoaderAndValidationLayers/vk-layer-generate.py line #961
        uint64_t unique_id = global_unique_id++;
...
// CODEGEN : file C:/releasebuild/LoaderAndValidationLayers/vk-layer-generate.py line #980
    VkResult result = get_dispatch_table(unique_objects_instance_table_map, physicalDevice)->GetDisplayPlaneCapabilitiesKHR(physicalDevice, mode, planeIndex, pCapabilities);
    return result;
}
...
// CODEGEN : file C:/releasebuild/LoaderAndValidationLayers/vk-layer-generate.py line #980
    VkResult result = get_dispatch_table(unique_objects_instance_table_map, instance)->CreateDisplayPlaneSurfaceKHR(instance, (const VkDisplaySurfaceCreateInfoKHR*)local_pCreateInfo, pAllocator, pSurface);
    if (local_pCreateInfo)
        delete local_pCreateInfo;
    if (VK_SUCCESS == result) {
        std::lock_guard<std::mutex> lock(global_lock);
...
// CODEGEN : file C:/releasebuild/LoaderAndValidationLayers/vk-layer-generate.py line #468
...
// CODEGEN : file C:/releasebuild/LoaderAndValidationLayers/vk-layer-generate.py line #502
...
// CODEGEN : file C:/releasebuild/LoaderAndValidationLayers/vk-layer-generate.py line #550
...
// CODEGEN : file C:/releasebuild/LoaderAndValidationLayers/vk-layer-generate.py line #590
...
// CODEGEN : file C:/releasebuild/LoaderAndValidationLayers/vk-layer-generate.py line #590
static inline PFN_vkVoidFunction intercept_display_enabled_command(const char *name, VkInstance instance)
{
    VkLayerInstanceDispatchTable* pTable = get_dispatch_table(unique_objects_instance_table_map, instance);
    if (instanceExtMap.size() == 0 || !instanceExtMap[pTable].display_enabled)
        return nullptr;
...
// CODEGEN : file C:/releasebuild/LoaderAndValidationLayers/vk-layer-generate.py line #590
static inline PFN_vkVoidFunction intercept_win32_enabled_command(const char *name, VkInstance instance)
{
    VkLayerInstanceDispatchTable* pTable = get_dispatch_table(unique_objects_instance_table_map, instance);
    if (instanceExtMap.size() == 0 || !instanceExtMap[pTable].win32_enabled)
        return nullptr;
...
VKAPI_ATTR PFN_vkVoidFunction VKAPI_CALL GetInstanceProcAddr(VkInstance instance, const char* funcName)
{
    ...
    addr = intercept_display_enabled_command(funcName, instance);
    if (addr)
        return addr;

    addr = intercept_win32_enabled_command(funcName, instance);
    if (addr)
        return addr;
...
// CODEGEN : file C:/releasebuild/LoaderAndValidationLayers/vk-layer-generate.py line #382
