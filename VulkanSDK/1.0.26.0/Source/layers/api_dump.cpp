...
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #854
#include <fstream>
#include <iostream>
#include <string>
#include <string.h>
...
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #913
...
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #922
...
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #947
...
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #989
...
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1017
...
VK_LAYER_EXPORT VKAPI_ATTR VkResult VKAPI_CALL vkCreateInstance(const VkInstanceCreateInfo* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkInstance* pInstance)
{
    ...
    // CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1047
...
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1114
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1123
        if (pCreateInfo) {
...
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1114
        uint32_t i;
        if (pPhysicalDevices) {
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1146
...
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1201
...
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #300
...
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #327
...
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #337
...
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #351
...
VK_LAYER_EXPORT VKAPI_ATTR VkResult VKAPI_CALL vkCreateWin32SurfaceKHR(VkInstance instance, const VkWin32SurfaceCreateInfoKHR* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkSurfaceKHR* pSurface)
{
    ...
    // CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1047
    if (StreamControl::writeAddress == true) {
        (*outputStream) << "t{" << getTIDIndex() << "} f{" << g_frameCounter << "} vkCreateWin32SurfaceKHR(instance = 0x" << nouppercase <<  hex << HandleCast(instance) << dec << ", pCreateInfo = 0x" << nouppercase <<  hex << HandleCast(pCreateInfo) << dec << ", pAllocator = 0x" << nouppercase <<  hex << HandleCast(pAllocator) << dec << ", " << (pSurface ? "*" : "") << "pSurface = 0x" << nouppercase <<  hex << (pSurface ? HandleCast(*pSurface) : 0) << dec << ") = " << string_VkResult((VkResult)result) << endl;
    }
    else {
        (*outputStream) << "t{" << getTIDIndex() << "} f{" << g_frameCounter << "} vkCreateWin32SurfaceKHR(instance = address, pCreateInfo = address, pAllocator = address, pSurface = address) = " << string_VkResult((VkResult)result) << endl;
    }
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1107
    if (g_ApiDumpDetailed) {
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1114
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1123
        if (pCreateInfo) {
            string tmp_str = vk_print_vkwin32surfacecreateinfokhr(pCreateInfo, "    ");
            (*outputStream) << "   pCreateInfo:\n" << tmp_str << endl;
        }
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1123
        if (pAllocator) {
...
VK_LAYER_EXPORT VKAPI_ATTR VkBool32 VKAPI_CALL vkGetPhysicalDeviceWin32PresentationSupportKHR(VkPhysicalDevice physicalDevice, uint32_t queueFamilyIndex)
{
    ...
    // CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1047
    if (StreamControl::writeAddress == true) {
        (*outputStream) << "t{" << getTIDIndex() << "} f{" << g_frameCounter << "} vkGetPhysicalDeviceWin32PresentationSupportKHR(physicalDevice = 0x" << nouppercase <<  hex << HandleCast(physicalDevice) << dec << ", queueFamilyIndex = 0x" << nouppercase <<  hex << queueFamilyIndex << dec << ")\n";
    }
    else {
        (*outputStream) << "t{" << getTIDIndex() << "} f{" << g_frameCounter << "} vkGetPhysicalDeviceWin32PresentationSupportKHR(physicalDevice = address, queueFamilyIndex = address)\n";
    }
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1107
    if (g_ApiDumpDetailed) {
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #1114
...
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #409
...
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #543
...
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #581
    {
...
// CODEGEN : file C:/releasebuild/VulkanTools/vk-vtlayer-generate.py line #588
