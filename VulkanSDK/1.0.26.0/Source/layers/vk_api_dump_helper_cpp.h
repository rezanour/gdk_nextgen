...
// CODEGEN : file C:/releasebuild/VulkanTools/vk_helper_api_dump.py line #914
...
// CODEGEN : file C:/releasebuild/VulkanTools/vk_helper_api_dump.py line #924
// CODEGEN : file C:/releasebuild/VulkanTools/vk_helper_api_dump.py line #936
std::string vk_print_vkallocationcallbacks(const VkAllocationCallbacks* pStruct, const std::string prefix)
{
// CODEGEN : file C:/releasebuild/VulkanTools/vk_helper_api_dump.py line #942
    ...
    stringstream ss[6];
// CODEGEN : file C:/releasebuild/VulkanTools/vk_helper_api_dump.py line #1105
    if (StreamControl::writeAddress)
        ss[0] << "0x" << hex << nouppercase << HandleCast(pStruct->pUserData) << dec;
    else
        ss[0].str("address");
// CODEGEN : file C:/releasebuild/VulkanTools/vk_helper_api_dump.py line #1126: NB: Edit here to choose hex vs dec output by variable name
...
// CODEGEN : file C:/releasebuild/VulkanTools/vk_helper_api_dump.py line #1150
...
// CODEGEN : file C:/releasebuild/VulkanTools/vk_helper_api_dump.py line #942
    ...
    stringstream ss[3];
    string stp_strs[1];
// CODEGEN : file C:/releasebuild/VulkanTools/vk_helper_api_dump.py line #1042
    if (pStruct->pNext) {
// CODEGEN : file C:/releasebuild/VulkanTools/vk_helper_api_dump.py line #1046
        tmp_str = dynamic_display((void*)pStruct->pNext, prefix);
// CODEGEN : file C:/releasebuild/VulkanTools/vk_helper_api_dump.py line #1056
...
// CODEGEN : file C:/releasebuild/VulkanTools/vk_helper_api_dump.py line #1120
...
// CODEGEN : file C:/releasebuild/VulkanTools/vk_helper_api_dump.py line #1105
    if (StreamControl::writeAddress)
        ...
        ss[0].str("address");
// CODEGEN : file C:/releasebuild/VulkanTools/vk_helper_api_dump.py line #1111
    if (pStruct->pApplicationName != NULL) {
        ss[1] << pStruct->pApplicationName;
     } else {
        ss[1] << "";
     }
// CODEGEN : file C:/releasebuild/VulkanTools/vk_helper_api_dump.py line #1129: NB Edit this section to choose hex vs dec output by variable name
...
// CODEGEN : file C:/releasebuild/VulkanTools/vk_helper_api_dump.py line #1056
        ...
        stp_strs[0] = "";
// CODEGEN : file C:/releasebuild/VulkanTools/vk_helper_api_dump.py line #961
// CODEGEN : file C:/releasebuild/VulkanTools/vk_helper_api_dump.py line #963
// CODEGEN : file C:/releasebuild/VulkanTools/vk_helper_api_dump.py line #968
    stp_strs[1] = "";
    ...
    if (pStruct->pWaitSemaphores) {
        for (uint32_t i = 0; i < pStruct->waitSemaphoreCount; i++) {
            index_ss.str("");
            index_ss << i;
// CODEGEN : file C:/releasebuild/VulkanTools/vk_helper_api_dump.py line #1008
// CODEGEN : file C:/releasebuild/VulkanTools/vk_helper_api_dump.py line #1014
            ss[1] << "0x" << hex << nouppercase << HandleCast(pStruct->pWaitSemaphores[i]) << dec;
            stp_strs[1] += " " + prefix + "pWaitSemaphores[" + index_ss.str() + "] = " + ss[1].str() + "\n";
// CODEGEN : file C:/releasebuild/VulkanTools/vk_helper_api_dump.py line #1030
            ss[1].str("");
        }
    }
// CODEGEN : file C:/releasebuild/VulkanTools/vk_helper_api_dump.py line #961
...
// CODEGEN : file C:/releasebuild/VulkanTools/vk_helper_api_dump.py line #1011
...
// CODEGEN : file C:/releasebuild/VulkanTools/vk_helper_api_dump.py line #1096
    ...
    if (pStruct->sharingMode == VK_SHARING_MODE_CONCURRENT) {
        if (pStruct->pQueueFamilyIndices) {
            for (uint32_t i = 0; i < pStruct->queueFamilyIndexCount; i++) {
                index_ss.str("");
                index_ss << i;
// CODEGEN : file C:/releasebuild/VulkanTools/vk_helper_api_dump.py line #1018
...
// CODEGEN : file C:/releasebuild/VulkanTools/vk_helper_api_dump.py line #942
    ...
    stringstream ss[6];
    string stp_strs[3];
// CODEGEN : file C:/releasebuild/VulkanTools/vk_helper_api_dump.py line #1064
    tmp_str = vk_print_vkimagesubresourcelayers(&pStruct->imageSubresource, extra_indent);
// CODEGEN : file C:/releasebuild/VulkanTools/vk_helper_api_dump.py line #1071
...
// CODEGEN : file C:/releasebuild/VulkanTools/vk_helper_api_dump.py line #1088
...
// CODEGEN : file C:/releasebuild/VulkanTools/vk_helper_api_dump.py line #1085
...
// CODEGEN : file C:/releasebuild/VulkanTools/vk_helper_api_dump.py line #942
    ...
    string stp_strs[3];
// CODEGEN : file C:/releasebuild/VulkanTools/vk_helper_api_dump.py line #961
// CODEGEN : file C:/releasebuild/VulkanTools/vk_helper_api_dump.py line #966
// CODEGEN : file C:/releasebuild/VulkanTools/vk_helper_api_dump.py line #968
    stp_strs[0] = "";
    stringstream index_ss;
...
// CODEGEN : file C:/releasebuild/VulkanTools/vk_helper_api_dump.py line #1054
...
// CODEGEN : file C:/releasebuild/VulkanTools/vk_helper_api_dump.py line #1099
...
// CODEGEN : file C:/releasebuild/VulkanTools/vk_helper_api_dump.py line #942
    ...
    stringstream ss[2];
    string stp_strs[1];
// CODEGEN : file C:/releasebuild/VulkanTools/vk_helper_api_dump.py line #1093
...
// CODEGEN : file C:/releasebuild/VulkanTools/vk_helper_api_dump.py line #968
    ...
    if (pStruct->pDynamicStates) {
        for (uint32_t i = 0; i < pStruct->dynamicStateCount; i++) {
            index_ss.str("");
            index_ss << i;
// CODEGEN : file C:/releasebuild/VulkanTools/vk_helper_api_dump.py line #1003
...
// CODEGEN : file C:/releasebuild/VulkanTools/vk_helper_api_dump.py line #1136
    if (pStruct->pDynamicStates)
...
#endif //VK_USE_PLATFORM_XLIB_KHR
// CODEGEN : file C:/releasebuild/VulkanTools/vk_helper_api_dump.py line #1158
...
// CODEGEN : file C:/releasebuild/VulkanTools/vk_helper_api_dump.py line #1167
...
// CODEGEN : file C:/releasebuild/VulkanTools/vk_helper_api_dump.py line #1177
...
// CODEGEN : file C:/releasebuild/VulkanTools/vk_helper_api_dump.py line #1184
std::string dynamic_display(const void* pStruct, const std::string prefix)
{
    using namespace std;
    ...
    switch (sType)
    {
        ...
        default:
        return string();
// CODEGEN : file C:/releasebuild/VulkanTools/vk_helper_api_dump.py line #1210
    }
}